...
const Page = () => {
  // Récupération de `data` et `lastEvent` depuis le contexte
  const { data, lastEvent, error } = useData();
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="ServicesContainer" id="nos-services">
          ...
          <div className="ListContainer">
            ...
            <ServiceCard imageSrc="/images/hall-expo.png">
              ...
              soit sa taille, en s’adaptant à votre demande et à vos besoins. En
              tant que spécialistes de l’évènementiel, nous saurons trouver le
              lieu parfait ainsi que des solutions inédites pour capter votre
        ...
        {/* Section Nos réalisations - Ajout de l'id */}
        <section className="EventsContainer" id="nos-realisations">
          <h2 className="Title">Nos réalisations</h2>
          <EventList />
        </section>

        {/* Section Notre équipe - Ajout de l'id */}
      ...
      <footer className="row">
        ...
        <div className="col description">
          ...
          <p>
            ...
            sportives et culturelles, et des événements professionnels.
          </p>
        </div>
      </footer>
    </>
